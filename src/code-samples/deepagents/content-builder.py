"""Content builder agent with brand memory, skills, subagents, and image generation."""

# :snippet-start: content-builder-tools-py
import os
...
# :snippet-start: content-builder-create-agent-py
...
if __name__ == "__main__":
    ...
    assert generate_cover.name == "generate_cover"
    assert generate_social_image.name == "generate_social_image"
    print("✓ Content builder agent components defined correctly")
# :remove-end:
