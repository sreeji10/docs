...
- [Create a new dataset from the dataset page](#create-a-new-dataset-from-the-datasets-&-experiments-page)
...
1. Click **+New** if you're starting a new dataset or select from an existing dataset.
    ...
    <Note>
    Creating datasets inline in the Playground is not supported for datasets that have nested keys. In order to add/edit examples with nested keys, you must edit [from the datasets page](/langsmith/manage-datasets-in-application#create-a-new-dataset-from-the-datasets--experiments-page).
    </Note>
