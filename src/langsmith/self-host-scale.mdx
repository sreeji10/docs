---
title: Scale self-hosted observability and evaluation infrastructure
sidebarTitle: Scale observability infrastructure
description: Configure your self-hosted LangSmith instance to handle high volumes of trace ingestion, evaluation workloads, and concurrent users
---
...
This page covers scaling the **self-hosted LangSmith platform**, the infrastructure that powers **observability** (trace ingestion and querying) and **evaluation** workloads.

<Tip>
To scale the infrastructure for **agents deployed on LangSmith Deployment**, see [Configure Agent Server for scale](/langsmith/agent-server-scale).
</Tip>
