...
- **LangGraph cross-workspace tracing**: For [LangGraph applications](/oss/langgraph/overview), use `LangChainTracer` with the workspace-specific client and attach it via the `callbacks` parameter.
