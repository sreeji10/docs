...
LangSmith connects to OSS clustering policy instances using standard Redis Cluster mode.
...
**Standalone Redis (OSS standalone or EnterpriseCluster):**
...
**Redis Cluster (OSS clustering policy):**
