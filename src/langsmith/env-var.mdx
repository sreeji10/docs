...
MongoDB connection URI for the MongoDB checkpointer backend. To use, you must set
```json
{
    "checkpointer": {
        "backend": "mongo",
...
```
in your config file OR have `LS_DEFAULT_CHECKPOINTER_BACKEND=mongo` set in your environment.
