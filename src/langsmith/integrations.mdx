...
**Using Langchain?** LangChain provides a unified interface to 100+ LLM providers, which allows you to switch between models by setting environment variables. [Initialize a model](/oss/langchain/models#initialize-a-model) and LangSmith will automatically trace your application.
</Callout>
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
    ...
    <a href="/langsmith/trace-with-mastra" className="flex items-center justify-center gap-1.5 p-2 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 no-underline ">
        <img className="block dark:hidden w-5 h-5" src="/images/providers/light/mastra.svg" alt="" />
        <img className="hidden dark:block w-5 h-5" src="/images/providers/dark/mastra.svg" alt="" />
    ...
    <a href="/langsmith/trace-with-opentelemetry" className="flex items-center justify-center gap-1.5 p-2 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 no-underline ">
        <img className="block dark:hidden w-5 h-5" src="/images/providers/light/opentelemetry.svg" alt="" />
        <img className="hidden dark:block w-5 h-5" src="/images/providers/dark/opentelemetry.svg" alt="" />
    ...
    <a href="/langsmith/trace-with-pydantic-ai" className="flex items-center justify-center gap-1.5 p-2 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 no-underline ">
        <img className="block dark:hidden w-5 h-5" src="/images/providers/light/pydanticai.svg" alt="" />
        <img className="hidden dark:block w-5 h-5" src="/images/providers/dark/pydanticai.svg" alt="" />
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-3">
    <a href="/langsmith/trace-with-livekit" className="flex items-center justify-center gap-1.5 p-2 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 no-underline ">
        <img className="block dark:hidden w-5 h-5" src="/images/providers/light/livekit.svg" alt="" />
        <img className="hidden dark:block w-5 h-5" src="/images/providers/dark/livekit.svg" alt="" />
    ...
    <a href="/langsmith/trace-with-pipecat" className="flex items-center justify-center gap-1.5 p-2 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 no-underline ">
        <img className="block dark:hidden w-5 h-5" src="/images/providers/light/pipecat.svg" alt="" />
        <img className="hidden dark:block w-5 h-5" src="/images/providers/dark/pipecat.svg" alt="" />
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-3">
    ...
    <a href="/langsmith/trace-with-n8n" className="flex items-center justify-center gap-1.5 p-2 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 no-underline ">
        <img className="block dark:hidden w-5 h-5" src="/images/providers/light/n8n.svg" alt="" />
        <img className="hidden dark:block w-5 h-5" src="/images/providers/dark/n8n.svg" alt="" />
