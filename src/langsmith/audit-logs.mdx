...
<Note>
Audit logs are available on **Enterprise** plans. If you're interested in upgrading to Enterprise, [contact our sales team](https://www.langchain.com/contact-sales).
</Note>
...
- **Who** deleted an API key or modified a deployment?
- **When** was a new member invited, a role modified, or a bulk export created?
- **What** billing, SSO, or data retention configuration was updated?
- **Which** resource tags, custom charts, or model price maps were changed?
...
| **Bulk exports** | `create_bulk_export`, `cancel_bulk_export`, `create_bulk_export_destination`, `update_bulk_export_destination` |
...
Not yet. Audit logs currently focus on write operations. Support for read operations may be added in the future.
</Accordion>
