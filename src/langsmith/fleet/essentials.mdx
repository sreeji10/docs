...
<Note>
Fleet traces all agent runs and stores them in LangSmith. LLM providers do not retain your data. On LangSmith Cloud, trace data is stored in the EU with a 14-day retention period.
</Note>
