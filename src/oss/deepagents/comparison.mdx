...
- **Production deployment**: Deploy via [LangSmith](/oss/langgraph/deploy) or self-host with the Agent Server
...
| Production hosting | ✅ [LangGraph Platform](/oss/langgraph/deploy), self-hosted, or standalone | Build your own HTTP/WebSocket layer; run SDK in [containers](https://platform.anthropic.com/docs/en/agent-sdk/hosting) | ❌ |
