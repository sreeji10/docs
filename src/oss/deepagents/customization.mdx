...
The `deepagents` library also exposes [summarization tool middleware](/oss/deepagents/harness#summarization), enabling agents to trigger summarization at opportune times—such as between tasks—instead of at fixed token intervals.
