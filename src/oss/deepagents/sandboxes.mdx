...
Choose how sandbox lifecycles map to your application's resources. See [going to production](/oss/deepagents/going-to-production#sandboxes) for more on this decision.
...
Best for: persistent dev environments, long-running projects.
