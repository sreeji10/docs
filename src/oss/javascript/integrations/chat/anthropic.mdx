...
sidebarTitle: "Chat"
description: "Integrate with the ChatAnthropic chat model using LangChain JavaScript."
---
...
Here's an example of caching part of a system message that contains the LangChain [conceptual docs](/oss/concepts/):
...
[Learn more about tool calling](/oss/langchain/tools)
