...
This will help you get started with the Slack [toolkit](/oss/integrations/tools/slack). For detailed documentation of all SlackToolkit features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-community/agent_toolkits/slack/toolkit/SlackToolkit).
