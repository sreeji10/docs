---
title: "Requests toolkit integration"
description: "Integrate with the Requests toolkit using LangChain Python."
---

We can use the Requests [toolkit](/oss/integrations/tools/requests) to construct agents that generate HTTP requests.

For detailed documentation of all API toolkit features and configurations head to the API reference for [RequestsToolkit](https://reference.langchain.com/python/langchain-community/agent_toolkits/openapi/toolkit/RequestsToolkit).
