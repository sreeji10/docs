---
title: "SQLDatabase toolkit integration"
description: "Integrate with the SQLDatabase toolkit using LangChain Python."
---

This will help you get started with the SQL Database [toolkit](/oss/integrations/tools/sql_database). For detailed documentation of all `SQLDatabaseToolkit` features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-community/agent_toolkits/sql/toolkit/SQLDatabaseToolkit).
...
- a [SQLDatabase](https://reference.langchain.com/python/langchain-community/utilities/sql_database/SQLDatabase) object;
- a LLM or chat model (for instantiating the [QuerySQLCheckerTool](https://reference.langchain.com/python/langchain-community/tools/sql_database/tool/QuerySQLCheckerTool) tool).
...
`SQLDatabaseToolkit` implements a [.get_context](https://reference.langchain.com/python/langchain-community/agent_toolkits/sql/toolkit/SQLDatabaseToolkit) method as a convenience for use in prompts or other contexts.
...
For detailed documentation of all SQLDatabaseToolkit features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-community/agent_toolkits/sql/toolkit/SQLDatabaseToolkit).
