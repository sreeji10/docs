---
title: "Financialdatasets toolkit integration"
description: "Integrate with the Financialdatasets toolkit using LangChain Python."
---
...
For detailed documentation of all `FinancialDatasetsToolkit` features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-community/agent_toolkits/financial_datasets/toolkit/FinancialDatasetsToolkit).
