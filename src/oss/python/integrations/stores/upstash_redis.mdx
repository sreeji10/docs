---
title: "Upstashredisbytestore integration"
description: "Integrate with the Upstashredisbytestore using LangChain Python."
---

This will help you get started with Upstash redis [key-value stores](/oss/integrations/stores). For detailed documentation of all `UpstashRedisByteStore` features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-community/storage/upstash_redis/UpstashRedisByteStore).
...
To use the base `RedisStore` instead, see [RedisStore](/oss/integrations/stores/redis/).
...
For detailed documentation of all `UpstashRedisByteStore` features and configurations, head to the API reference: [API reference](https://reference.langchain.com/python/langchain-community/storage/upstash_redis/UpstashRedisByteStore)
