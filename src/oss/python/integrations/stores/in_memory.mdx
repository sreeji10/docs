---
title: "InMemoryByteStore integration"
description: "Integrate with the InMemoryByteStore store using LangChain Python."
---

This guide will help you get started with in-memory [key-value stores](/oss/integrations/stores). For detailed documentation of all `InMemoryByteStore` features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-core/stores/InMemoryByteStore).
...
For detailed documentation of all `InMemoryByteStore` features and configurations, head to the API reference: [API reference](https://reference.langchain.com/python/langchain-core/stores/InMemoryByteStore)
