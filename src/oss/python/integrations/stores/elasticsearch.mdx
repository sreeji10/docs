---
title: "ElasticsearchEmbeddingsCache integration"
description: "Integrate with the ElasticsearchEmbeddingsCache store using LangChain Python."
---
...
Like other `ByteStores`, you can use an `ElasticsearchEmbeddingsCache` instance for [persistent caching in document ingestion](/oss/integrations/embeddings#caching) for RAG.
...
For detailed documentation of all `ElasticsearchEmbeddingsCache` features and configurations, head to the API reference: [API reference](https://reference.langchain.com/python/langchain-elasticsearch/cache/ElasticsearchEmbeddingsCache)
