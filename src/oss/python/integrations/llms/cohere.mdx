...
Cohere supports all [LLM](/oss/langchain/models) functionality:
...
For detailed documentation of all `Cohere` llm features and configurations head to the API reference: [API reference](https://reference.langchain.com/python/langchain-community/llms/cohere/Cohere)
