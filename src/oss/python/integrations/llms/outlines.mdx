...
description: "Integrate with the Outlines LLM using LangChain Python."
---

This will help you get started with Outlines LLM. For detailed documentation of all Outlines features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-community/llms/outlines/Outlines).
