---
title: "Oci data science model deployment endpoint integration"
description: "Integrate with the Oci data science model deployment endpoint LLM using LangChain Python."
---
