---
title: "TavilySearchAPI integration"
description: "Integrate with the TavilySearchAPI retriever using LangChain Python."
---
...
For detailed documentation of all `TavilySearchAPIRetriever` features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-community/retrievers/tavily_search_api/TavilySearchAPIRetriever).
