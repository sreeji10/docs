...
description: "Integrate with the Azure AI search retriever using LangChain Python."
---
...
For detailed documentation of all `AzureAISearchRetriever` features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-community/retrievers/azure_ai_search/AzureAISearchRetriever).
