...
|-----------|---------|---------|
| [`ArxivRetriever`](/oss/integrations/retrievers/arxiv) | Scholarly articles on [arxiv.org](https://arxiv.org/) | [`langchain-community`](https://reference.langchain.com/python/langchain-community/retrievers/arxiv/ArxivRetriever) |
| [`TavilySearchAPIRetriever`](/oss/integrations/retrievers/tavily) | Internet search | [`langchain-community`](https://reference.langchain.com/python/langchain-community/retrievers/tavily_search_api/TavilySearchAPIRetriever) |
| [`WikipediaRetriever`](/oss/integrations/retrievers/wikipedia) | [Wikipedia](https://www.wikipedia.org/) articles | [`langchain-community`](https://reference.langchain.com/python/langchain-community/retrievers/wikipedia/WikipediaRetriever) |
