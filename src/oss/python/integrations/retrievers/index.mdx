...
| [`NVIDIARAGRetriever`](/oss/integrations/retrievers/nvidia) | ✅ | ❌ | [`langchain-nvidia-ai-endpoints`](https://python.langchain.com/api_reference/nvidia_ai_endpoints/retrievers/langchain_nvidia_ai_endpoints.retrievers.NVIDIARAGRetriever.html) |
