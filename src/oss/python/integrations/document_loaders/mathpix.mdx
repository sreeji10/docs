---
title: "MathpixPDFLoader integration"
description: "Integrate with the MathpixPDFLoader document loader using LangChain Python."
---
...
For detailed documentation of all MathpixPDFLoader features and configurations head to the API reference: [API reference](https://reference.langchain.com/python/langchain-community/document_loaders/pdf/MathpixPDFLoader)
