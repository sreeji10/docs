---
title: "SitemapLoader integration"
description: "Integrate with the SitemapLoader document loader using LangChain Python."
---
...
For detailed documentation of all SiteMapLoader features and configurations head to the API reference: [API reference](https://reference.langchain.com/python/langchain-community/document_loaders/sitemap/SitemapLoader)
