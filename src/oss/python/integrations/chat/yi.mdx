...
This will help you get started with Yi [chat models](/oss/langchain/models). For detailed documentation of all ChatYi features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-community/chat_models/yi/ChatYi).
