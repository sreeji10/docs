...
This guide helps you get started with AI/ML API [chat models](/oss/langchain/models). For detailed documentation of all `ChatAIMLAPI` features and configurations, head to the [API reference](https://reference.langchain.com/python/langchain-aimlapi/chat_models/ChatAIMLAPI).
