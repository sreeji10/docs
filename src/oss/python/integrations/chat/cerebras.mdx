---
title: "ChatCerebras integration"
description: "Integrate with the ChatCerebras chat model using LangChain Python."
---

This guide provides a quick overview for getting started with Cerebras [chat models](/oss/langchain/models). For detailed documentation of all ChatCerebras features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-cerebras/chat_models/ChatCerebras).
...
| Class | Package | Serializable | [JS support](https://js.langchain.com/docs/integrations/chat/cerebras) | Downloads | Version |
| :--- | :--- | :---: |  :---: | :---: | :---: |
...
For detailed documentation of all ChatCerebras features and configurations head to the API reference: [API reference](https://reference.langchain.com/python/langchain-cerebras/chat_models/ChatCerebras)
