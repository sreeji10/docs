...
chat_model = ChatDatabricks(
    ...
    temperature=0.1,
    max_tokens=256,
    # See https://reference.langchain.com/python/langchain-community/chat_models/databricks/ChatDatabricks for other supported parameters
)
```
...
See [Databricks Unity Catalog](/oss/integrations/tools/databricks) about how to use UC functions in chains.
