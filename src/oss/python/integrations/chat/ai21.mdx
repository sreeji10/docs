---
title: "ChatAI21 integration"
description: "Integrate with the ChatAI21 chat model using LangChain Python."
---
...
| :--- | :--- | :---: |  :---: | :---: | :---: |
| [ChatAI21](https://reference.langchain.com/python/langchain-ai21/chat_models/ChatAI21) | [langchain-ai21](https://reference.langchain.com/python/langchain-ai21) | beta | ✅ | ![PyPI - Downloads](https://img.shields.io/pypi/dm/langchain-ai21?style=flat-square&label=%20) | ![PyPI - Version](https://img.shields.io/pypi/v/langchain-ai21?style=flat-square&label=%20) |
...
For detailed documentation of all ChatAI21 features and configurations head to the API reference: [API reference](https://reference.langchain.com/python/langchain-ai21/chat_models/ChatAI21)
