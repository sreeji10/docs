...
Head to the [API reference](https://reference.langchain.com/python/langchain-community/chat_models/cohere/ChatCohere) for detailed documentation of all attributes and methods.
...
ChatCohere supports all [ChatModel](/oss/langchain/models) functionality:
