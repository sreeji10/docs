...
See a [usage example](/oss/integrations/document_loaders/azure_ai_data).
...
See a [usage example](/oss/integrations/document_loaders/azure_document_intelligence).
...
See [usage examples for the Azure Blob Storage Loader](/oss/integrations/document_loaders/azure_blob_storage).
...
See a [usage example](/oss/integrations/document_loaders/microsoft_onedrive).
...
See a [usage example](/oss/integrations/document_loaders/microsoft_word).
...
See a [usage example](/oss/integrations/document_loaders/microsoft_excel).
...
See a [usage example](/oss/integrations/document_loaders/microsoft_sharepoint).
...
See a [usage example](/oss/integrations/document_loaders/microsoft_powerpoint).
...
See a [usage example](/oss/integrations/document_loaders/microsoft_onenote).
...
See a [usage example](/oss/integrations/document_loaders/url/#playwright-url-loader).
...
Since Azure Database for PostgreSQL is open-source Postgres, you can use the [LangChain's Postgres support](/oss/integrations/vectorstores/pgvector/) to connect to Azure Database for PostgreSQL.
...
See [detail configuration instructions](/oss/integrations/vectorstores/sqlserver).
...
See a [usage example](/oss/integrations/vectorstores/sqlserver).
...
queries at scale. See the [Azure AI Search usage examples](/oss/integrations/vectorstores/azuresearch) for usage examples.
...
See a [usage example](/oss/integrations/retrievers/azure_ai_search).
...
You need to [enable pgvector extension](https://learn.microsoft.com/en-us/azure/postgresql/flexible-server/how-to-use-pgvector) in your database to use Postgres as a vector store. Once you have the extension enabled, you can use the [PGVector in LangChain](/oss/integrations/vectorstores/pgvector/) to connect to Azure Database for PostgreSQL.

See a [usage example](/oss/integrations/vectorstores/pgvector/). Simply use the [connection string](https://learn.microsoft.com/en-us/azure/postgresql/flexible-server/connect-python?tabs=cmd%2Cpassword#add-authentication-code) from your Azure Portal.
...
See the [Azure dynamic sessions setup instructions](/oss/integrations/tools/azure_dynamic_sessions/#setup).
...
See a [usage example](/oss/integrations/tools/azure_dynamic_sessions).
...
Follow the [Bing search tool documentation](/oss/integrations/tools/bing_search) to get a detailed explanations and instructions for this tool.
...
See a [usage example](/oss/integrations/tools/azure_ai_services).
...
See a [usage example](/oss/integrations/tools/azure_cognitive_services).
...
See a [usage example](/oss/integrations/tools/office365).
...
See a [usage example](/oss/integrations/tools/powerbi).
...
See a [usage example](/oss/integrations/tools/playwright).
...
See a [usage example](/oss/integrations/graphs/azure_cosmosdb_gremlin).
...
See a [usage example](/oss/integrations/tools/bing_search).
