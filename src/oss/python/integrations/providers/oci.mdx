...
See [usage example](/oss/integrations/chat/oci_generative_ai).
...
See [usage example](/oss/integrations/embeddings/oci_generative_ai).
...
See [usage example](/oss/integrations/chat/oci_data_science).
