...
See the API Reference for the [AstraDBStore](https://reference.langchain.com/python/langchain-astradb/storage/AstraDBStore).
...
See the API reference for the [AstraDBByteStore](https://reference.langchain.com/python/langchain-astradb/storage/AstraDBByteStore).
