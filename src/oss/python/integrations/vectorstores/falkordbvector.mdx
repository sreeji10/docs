---
title: "FalkorDBVectorStore integration"
...
For detailed documentation of all `FalkorDBVector` features and configurations head to the API reference: [API reference](https://reference.langchain.com/python/langchain-community/vectorstores/falkordb_vector/FalkorDBVector)
