...
[API reference](https://reference.langchain.com/python/langchain-pinecone/vectorstores_sparse/PineconeSparseVectorStore)

Sparse Embeddings:
[API reference](https://reference.langchain.com/python/langchain-pinecone/embeddings/PineconeSparseEmbeddings)
