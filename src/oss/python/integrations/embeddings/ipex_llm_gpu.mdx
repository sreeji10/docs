...
>
> For other GPU types, see the [IPEX-LLM Windows runtime configuration](https://github.com/intel-analytics/ipex-llm/blob/main/docs/mddocs/Overview/install_gpu.md#runtime-configuration) or [IPEX-LLM Linux runtime configuration](https://github.com/intel-analytics/ipex-llm/blob/main/docs/mddocs/Overview/install_gpu.md#runtime-configuration-1).
