---
title: "ZhipuAIEmbeddings integration"
description: "Integrate with the ZhipuAIEmbeddings embedding model using LangChain Python."
---
...
| Provider | Package |
|:--------:|:-------:|
| [ZhipuAI](/oss/integrations/providers/zhipuai/) | [langchain-community](https://reference.langchain.com/python/langchain-community/embeddings/zhipuai/ZhipuAIEmbeddings) |
...
For detailed documentation on `ZhipuAIEmbeddings` features and configuration options, please refer to the [API reference](https://reference.langchain.com/python/langchain-community/embeddings/zhipuai/ZhipuAIEmbeddings).
