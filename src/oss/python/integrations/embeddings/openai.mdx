---
title: "OpenAIEmbeddings integration"
description: "Integrate with the OpenAIEmbeddings embedding model using LangChain Python."
---
...
<Info>
    **Azure OpenAI v1 API support**
    ...
    For the traditional Azure-specific implementation, continue to use [`AzureOpenAIEmbeddings`](/oss/integrations/embeddings/azure_openai).
</Info>
