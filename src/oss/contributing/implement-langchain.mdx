...
<Tabs>
    ...
    <Tab title="Middleware">
        ...
        See the [middleware integration guide](/oss/contributing/guide/middleware) for a step-by-step walkthrough of implementing, testing, and publishing a middleware integration.
    </Tab>
