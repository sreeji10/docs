...
- [**Vector Stores**](/oss/integrations/vectorstores): Essential for semantic search
- [**Middleware**](/oss/integrations/middleware): Extend agent behavior with hooks
- [**Sandboxes**](/oss/deepagents/sandboxes): Run code safely with Deep Agents
...
<Steps>
    ...
    <Step title="Pass standard tests">
        If applicable, implement support for LangChain's [standard test](/oss/contributing/standard-tests-langchain) suite for your integration and successfully run them.
    </Step>
