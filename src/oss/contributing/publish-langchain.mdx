...
<Info>
    This guide assumes you have already implemented your package and written tests for it. If you haven't, please refer to the [implementation guide](/oss/contributing/implement-langchain) and [testing guide](/oss/contributing/standard-tests-langchain).
</Info>
...
To add documentation for your package to this site under the [integrations tab](/oss/integrations/providers/overview), you will need to create the relevant documentation pages and open a PR in the [LangChain docs repository](https://github.com/langchain-ai/docs).
...
<Tip>
    To reference existing documentation, you can look at the [list of integrations](/oss/integrations/providers/overview) and find similar ones to yours.
...
<Warning>
    ...
    - [Mintlify components](/oss/contributing/documentation#mintlify-components) are used incorrectly
    - Pages are missing a [frontmatter](/oss/contributing/documentation#page-structure)
    - [Localization](/oss/contributing/documentation#localization) is missing (where applicable)
    - [Code examples](/oss/contributing/documentation#in-code-documentation) do not run or have errors
    - [Quality standards](/oss/contributing/documentation#quality-standards) are not met
</Warning>
