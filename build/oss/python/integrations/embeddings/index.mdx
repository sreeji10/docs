...
| [`VoyageAIEmbeddings`](/oss/python/integrations/embeddings/voyageai)                  | [`langchain-voyageai`](https://reference.langchain.com/python/langchain-voyageai/embeddings/VoyageAIEmbeddings)                       |
...
| [`AIMLAPIEmbeddings`](/oss/python/integrations/embeddings/aimlapi)                  | [`langchain-aimlapi`](https://reference.langchain.com/python/langchain-aimlapi/embeddings/AIMLAPIEmbeddings)                           |
