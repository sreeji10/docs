---
title: "DatabricksEmbeddings integration"
description: "Integrate with the DatabricksEmbeddings embedding model using LangChain Python."
---

> [Databricks](https://www.databricks.com/) Lakehouse Platform unifies data, analytics, and AI on one platform.

This guide provides a quick overview for getting started with Databricks [embedding models](/oss/python/integrations/embeddings). For detailed documentation of all `DatabricksEmbeddings` features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-community/embeddings/databricks/DatabricksEmbeddings).
...
For detailed documentation on `DatabricksEmbeddings` features and configuration options, please refer to the [API reference](https://reference.langchain.com/python/langchain-community/embeddings/databricks/DatabricksEmbeddings).
