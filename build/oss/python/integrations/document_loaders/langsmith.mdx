...
description: "Integrate with the LangSmithLoader document loader using LangChain Python."
---
...
| :--- | :--- | :---: | :---: |  :---: |
| [LangSmithLoader](https://reference.langchain.com/python/langchain-core/document_loaders/langsmith/LangSmithLoader) | [langchain-core](https://reference.langchain.com/python/langchain-core) | ❌ | ❌ | ❌ |
...
For detailed documentation of all LangSmithLoader features and configurations head to the API reference: [API reference](https://reference.langchain.com/python/langchain-core/document_loaders/langsmith/LangSmithLoader)

---

<div className="source-links">
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/langsmith.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
