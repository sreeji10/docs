---
title: "Recursive URL integration"
description: "Integrate with the Recursive URL document loader using LangChain Python."
---
...
For detailed information on configuring and calling the `RecursiveUrlLoader`, please see the API reference: [API reference](https://reference.langchain.com/python/langchain-community/document_loaders/recursive_url_loader/RecursiveUrlLoader).

---

<div className="source-links">
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/recursive_url.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
