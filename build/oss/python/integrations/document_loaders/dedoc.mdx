---
title: "Dedoc integration"
description: "Integrate with the Dedoc document loader using LangChain Python."
---
...
Find the full list of supported formats in the [Dedoc supported formats documentation](https://dedoc.readthedocs.io/en/latest/#id1).
...
For `Dedoc` installation instructions, see the [Dedoc installation documentation](https://dedoc.readthedocs.io/en/latest/getting_started/installation.html).
...
* [API reference](https://reference.langchain.com/python/langchain-community/document_loaders/dedoc/DedocFileLoader)
* [API reference](https://reference.langchain.com/python/langchain-community/document_loaders/pdf/DedocPDFLoader)
* [API reference](https://reference.langchain.com/python/langchain-community/document_loaders/dedoc/DedocAPIFileLoader)
...
* `document` (default value): document text is returned as a single langchain [`Document`](https://reference.langchain.com/python/langchain-core/documents/base/Document) object (don't split);
...
Tables are not split - each table corresponds to one langchain [`Document`](https://reference.langchain.com/python/langchain-core/documents/base/Document) object.
For tables, [`Document`](https://reference.langchain.com/python/langchain-core/documents/base/Document) object has additional `metadata` fields `type="table"`
...
For attachments, langchain [`Document`](https://reference.langchain.com/python/langchain-core/documents/base/Document) object has an additional metadata
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/dedoc.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
