---
title: "ZeroxPDFLoader integration"
description: "Integrate with the ZeroxPDFLoader document loader using LangChain Python."
---
...
- `lazy_load`: Generates an iterator of [`Document`](https://reference.langchain.com/python/langchain-core/documents/base/Document) instances, each representing a page of the PDF, along with metadata including page number and source.

See the [full API documentation](https://reference.langchain.com/python/langchain-community/document_loaders/pdf/ZeroxPDFLoader)
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/zeroxpdfloader.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
