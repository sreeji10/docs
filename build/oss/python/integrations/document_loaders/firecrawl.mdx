...
description: "Integrate with the FireCrawl document loader using LangChain Python."
---
...
| :--- | :--- | :---: | :---: |  :---: |
| [FireCrawlLoader](https://reference.langchain.com/python/langchain-community/document_loaders/firecrawl/FireCrawlLoader) | [langchain-community](https://reference.langchain.com/python/langchain-community) | ✅ | ❌ | ✅ |
...
For detailed documentation of all `FireCrawlLoader` features and configurations head to the API reference: [API reference](https://reference.langchain.com/python/langchain-community/document_loaders/firecrawl/FireCrawlLoader)

---

<div className="source-links">
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/firecrawl.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
