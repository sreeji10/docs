---
title: "PyMuPDFLoader integration"
description: "Integrate with the PyMuPDFLoader document loader using LangChain Python."
---
...
For detailed documentation of all `PyMuPDFLoader` features and configurations head to the API reference: [API reference](https://reference.langchain.com/python/langchain-community/document_loaders/pdf/PyMuPDFLoader)
