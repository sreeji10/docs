---
title: "WebBaseLoader integration"
description: "Integrate with the WebBaseLoader document loader using LangChain Python."
---
...
For detailed documentation of all `WebBaseLoader` features and configurations head to the API reference: [API reference](https://reference.langchain.com/python/langchain-community/document_loaders/web_base/WebBaseLoader)

---

<div className="source-links">
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/web_base.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
