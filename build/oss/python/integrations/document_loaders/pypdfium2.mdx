---
title: "Pypdfium2loader integration"
description: "Integrate with the Pypdfium2loader document loader using LangChain Python."
---
...
For detailed documentation of all `PyPDFium2Loader` features and configurations head to the API reference: [API reference](https://reference.langchain.com/python/langchain-community/document_loaders/pdf/PyPDFium2Loader)

---

<div className="source-links">
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/pypdfium2.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
