...
description: "Integrate with the Streamlit callback using LangChain Python."
---
...
[API reference](https://reference.langchain.com/python/langchain/callbacks/streamlit/streamlit_callback_handler/StreamlitCallbackHandler).
