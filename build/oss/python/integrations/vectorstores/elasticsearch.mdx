...
For detailed documentation of all `ElasticSearchStore` features and configurations head to the API reference: [API reference](https://reference.langchain.com/python/langchain-elasticsearch/vectorstores/ElasticsearchStore)
