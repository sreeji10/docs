...
For detailed documentation of all `MongoDBAtlasVectorSearch` features and configurations head to the API reference: [API reference](https://reference.langchain.com/python/langchain-mongodb)
