---
title: "Tablestore integration"
description: "Integrate with the Tablestore vector store using LangChain Python."
---
...
For detailed documentation of all `TablestoreVectorStore` features and configurations head to the API reference: [API reference](https://reference.langchain.com/python/langchain-community/vectorstores/tablestore/TablestoreVectorStore)

---

<div className="source-links">
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/vectorstores/tablestore.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
