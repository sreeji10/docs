...
description: "Integrate with the Chroma vector store using LangChain Python."
---
...
You can also transform the vector store into a retriever for easier usage in your chains. For more information on the different search types and kwargs you can pass, please visit the [Chroma API reference](https://reference.langchain.com/python/langchain-chroma/vectorstores/Chroma).
...
For detailed documentation of all `Chroma` vector store features and configurations head to the API reference: [API reference](https://reference.langchain.com/python/langchain-chroma/vectorstores/Chroma)
