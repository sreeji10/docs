---
title: "SQLiteVec integration"
description: "Integrate with the SQLiteVec vector store using LangChain Python."
---
...
For detailed documentation of all SQLiteVec features and configurations head to the API reference: [API reference](https://reference.langchain.com/python/langchain-community/vectorstores/sqlitevec/SQLiteVec)
