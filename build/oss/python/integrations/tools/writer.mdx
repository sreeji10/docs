...
description: "Integrate with the Writer tool using LangChain Python."
---
...
For detailed documentation of all `GraphTool` features and configurations, head to the [API reference](https://reference.langchain.com/python/langchain-writer/tools/GraphTool).
