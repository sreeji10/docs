---
title: "Github toolkit integration"
description: "Integrate with the Github toolkit using LangChain Python."
---
...
For detailed documentation of all GithubToolkit features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-community/agent_toolkits/github/toolkit/GitHubToolkit).
