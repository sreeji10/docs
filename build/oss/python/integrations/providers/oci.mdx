---
title: "Oracle cloud infrastructure (Oci) integrations"
description: "Integrate with Oracle cloud infrastructure (Oci) using LangChain Python."
---
...
See [chat](/oss/python/integrations/llms/oci_generative_ai), [complete](/oss/python/integrations/chat/oci_generative_ai), and [embedding](/oss/python/integrations/text_embedding/oci_generative_ai) usage examples.
...
See [chat](/oss/python/integrations/chat/oci_data_science) and [complete](/oss/python/integrations/llms/oci_model_deployment_endpoint) usage examples.
