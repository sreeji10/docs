...
See a [detailed usage example](/oss/python/integrations/vectorstores/moorcheh).
...
For more detailed examples and advanced usage, see the [Moorcheh vectorstore integration](/oss/python/integrations/vectorstores/moorcheh).

---

<div className="source-links">
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/moorcheh.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
