---
title: "VectorizeRetriever integration"
description: "Integrate with the VectorizeRetriever retriever using LangChain Python."
---
...
For detailed documentation of all VectorizeRetriever features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-vectorize/retrievers/VectorizeRetriever).

---

<div className="source-links">
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/retrievers/vectorize.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
