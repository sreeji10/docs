...
description: "Integrate with the Cognee retriever using LangChain Python."
---

# CogneeRetriever

This will help you get started with the Cognee [retriever](/oss/python/langchain/retrieval). For detailed documentation of all CogneeRetriever features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-community/retrievers/cognee/CogneeRetriever).
...
| :--- | :--- | :---: | :---: |
[CogneeRetriever](https://reference.langchain.com/python/langchain-community/retrievers/cognee/CogneeRetriever) | ✅ | ❌ | langchain-cognee |
