...
This will help you get started with the Box [retriever](/oss/python/langchain/retrieval). For detailed documentation of all BoxRetriever features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-box/retrievers/box/BoxRetriever).
...
| :--- | :--- | :---: | :---: |
[BoxRetriever](https://reference.langchain.com/python/langchain-box/retrievers/box/BoxRetriever) | ❌ | ✅ | langchain-box |
...
For detailed documentation of all BoxRetriever features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-box/retrievers/box/BoxRetriever).
