...
|-----------|---------|---------|
| [`ArxivRetriever`](/oss/python/integrations/retrievers/arxiv) | Scholarly articles on [arxiv.org](https://arxiv.org/) | [`langchain-community`](https://reference.langchain.com/python/langchain-community/retrievers/arxiv/ArxivRetriever) |
| [`TavilySearchAPIRetriever`](/oss/python/integrations/retrievers/tavily) | Internet search | [`langchain-community`](https://reference.langchain.com/python/langchain-community/retrievers/tavily_search_api/TavilySearchAPIRetriever) |
| [`WikipediaRetriever`](/oss/python/integrations/retrievers/wikipedia) | [Wikipedia](https://www.wikipedia.org/) articles | [`langchain-community`](https://reference.langchain.com/python/langchain-community/retrievers/wikipedia/WikipediaRetriever) |
