---
title: "Contextual AI reranker integration"
description: "Integrate with the Contextual AI reranker retriever using LangChain Python."
---
...
| :--- | :--- | :---: | :---: |  :---: | :---: | :---: |
| [ContextualRerank](https://reference.langchain.com/python/langchain-contextual/rerank/ContextualRerank) | [langchain-contextual](https://reference.langchain.com/python/langchain-contextual) | ❌ | beta | ❌ | ![PyPI - Downloads](https://img.shields.io/pypi/dm/langchain-contextual?style=flat-square&label=%20) | ![PyPI - Version](https://img.shields.io/pypi/v/langchain-contextual?style=flat-square&label=%20) |
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/retrievers/contextual.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
