---
title: "Cassandrabytestore integration"
description: "Integrate with the Cassandrabytestore using LangChain Python."
---

This will help you get started with Cassandra [key-value stores](/oss/python/integrations/stores). For detailed documentation of all `CassandraByteStore` features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-community/storage/cassandra/CassandraByteStore).
...
For detailed documentation of all `CassandraByteStore` features and configurations, head to the API reference: [API reference](https://reference.langchain.com/python/langchain-community/storage/cassandra/CassandraByteStore)
