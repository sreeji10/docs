---
title: "SambaStudio integration"
description: "Integrate with the SambaStudio LLM using LangChain Python."
---
...
For detailed documentation of all `SambaStudio` llm features and configurations head to the API reference: [API reference](https://reference.langchain.com/python/langchain-community/llms/sambanova/SambaStudio)

---

<div className="source-links">
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/llms/sambastudio.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
