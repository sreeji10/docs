---
title: "Oracle cloud infrastructure generative AI integration"
description: "Integrate with the Oracle cloud infrastructure generative AI embedding model using LangChain Python."
---
