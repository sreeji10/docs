...
| Provider | Package |
|----------|---------|
| [AgentCore](/oss/python/integrations/providers/aws#sandboxes) | [`langchain-agentcore-codeinterpreter`](https://pypi.org/project/langchain-agentcore-codeinterpreter/) |
