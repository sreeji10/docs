---
title: "Nebula (Symbl.ai) integration"
description: "Integrate with the Nebula (Symbl.ai) chat model using LangChain Python."
---
...
Check out the [API reference](https://reference.langchain.com/python/langchain-community/chat_models/symblai_nebula/ChatNebula) for more detail.
