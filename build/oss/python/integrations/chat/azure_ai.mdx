---
title: "AzureAIOpenAIApiChatModel integration"
description: "Integrate with the AzureAIOpenAIApiChatModel chat model using LangChain Python."
---

This will help you get started with `AzureAIOpenAIApiChatModel` [chat models](/oss/python/langchain/models). For detailed documentation of all `AzureAIOpenAIApiChatModel` features and configurations, head to the [API reference](https://reference.langchain.com/python/langchain-azure-ai/chat_models/AzureAIOpenAIApiChatModel)
