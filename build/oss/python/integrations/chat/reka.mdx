---
title: "ChatReka integration"
description: "Integrate with the ChatReka chat model using LangChain Python."
---
...
Note that we are passing in the model, not model_with_tools. That is because [`create_agent`](https://reference.langchain.com/python/langchain/agents/factory/create_agent) will call `.bind_tools` for us under the hood.
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/chat/reka.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
