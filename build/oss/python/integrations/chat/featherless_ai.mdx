---
title: "ChatFeatherlessAI integration"
description: "Integrate with the ChatFeatherlessAI chat model using LangChain Python."
---

This will help you get started with FeatherlessAi [chat models](/oss/python/langchain/models). For detailed documentation of all ChatFeatherlessAi features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-featherless-ai/chat_models/ChatFeatherlessAi).
...
| :--- | :--- | :---: |  :---: | :---: | :---: |
| [ChatFeatherlessAi](https://reference.langchain.com/python/langchain-featherless-ai/chat_models/ChatFeatherlessAi) | [langchain-featherless-ai](https://reference.langchain.com/python/langchain-featherless-ai) | ❌ | ❌ | ![PyPI - Downloads](https://img.shields.io/pypi/dm/langchain-featherless-ai?style=flat-square&label=%20) | ![PyPI - Version](https://img.shields.io/pypi/v/langchain-featherless-ai?style=flat-square&label=%20) |
...
For detailed documentation of all ChatFeatherlessAi features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-featherless-ai/chat_models/ChatFeatherlessAi)
