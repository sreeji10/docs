---
title: "ChatYi integration"
description: "Integrate with the ChatYi chat model using LangChain Python."
---

This will help you get started with Yi [chat models](/oss/python/langchain/models). For detailed documentation of all ChatYi features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-community/chat_models/yi/ChatYi).
...
| :--- | :--- | :---: |  :---: | :---: | :---: |
| [ChatYi](https://reference.langchain.com/python/langchain-community/chat_models/yi/ChatYi) | [langchain_community](https://reference.langchain.com/python/langchain-community) | ❌ | ❌ | ![PyPI - Downloads](https://img.shields.io/pypi/dm/langchain_community?style=flat-square&label=%20) | ![PyPI - Version](https://img.shields.io/pypi/v/langchain_community?style=flat-square&label=%20) |
...
For detailed documentation of all ChatYi features and configurations, head to the API reference: [API reference](https://reference.langchain.com/python/langchain-community/chat_models/yi/ChatYi)
