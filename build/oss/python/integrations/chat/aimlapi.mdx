...
This guide helps you get started with AI/ML API [chat models](/oss/python/langchain/models). For detailed documentation of all `ChatAIMLAPI` features and configurations, head to the [API reference](https://reference.langchain.com/python/langchain-aimlapi/chat_models/ChatAIMLAPI).
...
| :--- | :--- | :---: | :---: | :---: | :---: |
| [ChatAIMLAPI](https://reference.langchain.com/python/langchain-aimlapi/chat_models/ChatAIMLAPI) | [langchain-aimlapi](https://reference.langchain.com/python/langchain-aimlapi) | beta | ❌ | ![PyPI - Downloads](https://img.shields.io/pypi/dm/langchain-aimlapi?style=flat-square&label=%20) | ![PyPI - Version](https://img.shields.io/pypi/v/langchain-aimlapi?style=flat-square&label=%20) |
...
For detailed documentation of all ChatAIMLAPI features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-aimlapi/chat_models/ChatAIMLAPI).
