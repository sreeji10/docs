...
| :--- | :--- | :---: |  :---: |
| [ChatLlamaCpp](https://reference.langchain.com/python/langchain-community/chat_models/llamacpp/ChatLlamaCpp) | [langchain-community](https://reference.langchain.com/python/langchain-community) | ❌ | ❌ |
...
For detailed documentation of all ChatLlamaCpp features and configurations, head to the API reference: [API reference](https://reference.langchain.com/python/langchain-community/chat_models/llamacpp/ChatLlamaCpp)

---

<div className="source-links">
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/chat/llamacpp.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
