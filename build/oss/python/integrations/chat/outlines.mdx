---
title: "ChatOutlines integration"
description: "Integrate with the ChatOutlines chat model using LangChain Python."
---

This will help you get started with Outlines [chat models](/oss/python/langchain/models/). For detailed documentation of all ChatOutlines features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-community/chat_models/outlines/ChatOutlines).
...
| :--- | :--- | :---: |  :---: | :---: | :---: |
| [ChatOutlines](https://reference.langchain.com/python/langchain-community/chat_models/outlines/ChatOutlines) | [langchain-community](https://reference.langchain.com/python/langchain-community) | ❌ | ❌ | ![PyPI - Downloads](https://img.shields.io/pypi/dm/langchain-community?style=flat-square&label=%20) | ![PyPI - Version](https://img.shields.io/pypi/v/langchain-community?style=flat-square&label=%20) |
...
For detailed documentation of all ChatOutlines features and configurations head to the API reference: [API reference](https://reference.langchain.com/python/langchain-community/chat_models/outlines/ChatOutlines)
