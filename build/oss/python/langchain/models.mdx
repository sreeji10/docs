...
| :--- | :--- | :--- |
| [OpenAI](/oss/python/integrations/providers/openai) | `langchain-openai` | `gpt-4.1` |
| [Anthropic](/oss/python/integrations/providers/anthropic) | `langchain-anthropic` | `claude-sonnet-4-6` |
| [Google](/oss/python/integrations/providers/google) | `langchain-google-genai` | `gemini-2.5-flash` |
| [AWS Bedrock](/oss/python/integrations/providers/aws) | `langchain-aws` | `us.anthropic.claude-sonnet-4-6-v1` |
| [Azure](/oss/python/integrations/providers/microsoft) | `langchain-openai` | `gpt-4.1` |
| [Ollama](/oss/python/integrations/providers/ollama) | `langchain-ollama` | `llama3` |
...
For a complete list of providers, capabilities, and model names, see [Providers and models](/oss/python/concepts/providers-and-models) and the [integrations page](/oss/python/integrations/providers/overview).
