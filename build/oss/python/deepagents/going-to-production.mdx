...
You can hook into any point in the agent loop to add your own business logic. Available hooks include `before_model`, `after_model`, `wrap_model_call`, and `wrap_tool_call`. See [custom middleware](/oss/python/langchain/middleware/custom) for details.
