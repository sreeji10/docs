...
- **[Multi-tenancy and authentication](#multi-tenancy-and-authentication)**: identity, access control, and scoping
...
| Assistant | `(assistant_id)` | Shared instructions for one assistant | "Always use formal tone" for the email assistant |
