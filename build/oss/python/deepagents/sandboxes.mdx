...
<CardGroup cols={2}>
    <Card title="AgentCore" icon="/images/providers/agentcore-icon.svg" href="/oss/python/integrations/providers/aws#sandboxes">
...
Choose how sandbox lifecycles map to your application's resources. See [deployments](/oss/python/deepagents/deployments#sandboxes) for more on this decision.
