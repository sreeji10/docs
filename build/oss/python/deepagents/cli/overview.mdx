...
<AccordionGroup>
    <Accordion title="Slash commands" icon="slash">
        ...
        - `/reload` - Re-read `.env` files, refresh configuration, and re-discover skills without restarting. Conversation state is preserved. See [`DEEPAGENTS_CLI_` prefix](/oss/python/deepagents/cli/configuration#deepagents_cli_-prefix) for override behavior
