...
| :--- | :--- | :--- |
| [OpenAI](/oss/javascript/integrations/providers/openai) | `langchain-openai` | `gpt-4.1` |
| [Anthropic](/oss/javascript/integrations/providers/anthropic) | `langchain-anthropic` | `claude-sonnet-4-6` |
| [Google](/oss/javascript/integrations/providers/google) | `langchain-google-genai` | `gemini-2.5-flash` |
| [AWS Bedrock](/oss/javascript/integrations/providers/aws) | `langchain-aws` | `us.anthropic.claude-sonnet-4-6-v1` |
| [Azure](/oss/javascript/integrations/providers/microsoft) | `langchain-openai` | `gpt-4.1` |
| [Ollama](/oss/javascript/integrations/providers/ollama) | `langchain-ollama` | `llama3` |
...
For a complete list of providers, capabilities, and model names, see [Providers and models](/oss/javascript/concepts/providers-and-models) and the [integrations page](/oss/javascript/integrations/providers/overview).
