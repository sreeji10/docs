...
The agent will return a [`ToolMessage`](https://reference.langchain.com/javascript/langchain-core/messages/ToolMessage) with the custom error message when a tool fails.
