...
<AccordionGroup>
    ...
    <Accordion title="Add a new integration" icon="plug-connected">
        ...
        <Card title="Deep Agents sandboxes" icon="cube" href="/oss/javascript/contributing/integrations-langchain" arrow>Guide to contributing a sandbox integration</Card>
    </Accordion>
</AccordionGroup>
