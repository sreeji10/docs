...
If you provide a sandbox platform and want to contribute an integration, see [Contributing a sandbox integration](/oss/javascript/contributing/integrations-langchain).
...
Choose how sandbox lifecycles map to your application's resources. See [deployments](/oss/javascript/deepagents/deployments#sandboxes) for more on this decision.
