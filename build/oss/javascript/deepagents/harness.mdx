...
**How it works:**
- Sandbox backends implement [`SandboxBackendProtocol`](https://reference.langchain.com/javascript/deepagents/backends/SandboxBackendProtocol) — when detected, the harness adds the `execute` tool to the agent's available tools
