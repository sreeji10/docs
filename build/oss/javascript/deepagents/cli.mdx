...
<Steps>
    <Step title="Set your API key" icon="key">
        ...
        <Note>
            ...
            For more information see [Additional installation and configuration options](/oss/javascript/deepagents/cli#additional-installation-and-configuration-options).
        </Note>
    </Step>
