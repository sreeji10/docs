...
* <Icon icon="chart-dots" size={16} /> **[Tracing](/oss/javascript/deepagents/cli/overview#tracing-with-langsmith)** - trace agent operations, tool calls, and decisions in LangSmith for observability and debugging.
...
<Steps>
    <Step title="Set model credentials" icon="key">
        ...
        The CLI works with [any LLM that supports tool calling](/oss/javascript/deepagents/cli/providers) — OpenAI, Anthropic, Google, Ollama, and many more. See [Providers](#providers) for setup details.
    </Step>
