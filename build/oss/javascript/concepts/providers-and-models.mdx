...
const openaiModel = await initChatModel("openai:gpt-4.1");
...
| [Ollama](/oss/javascript/integrations/providers/ollama) | [Ollama model library](https://ollama.com/library) |
| [Groq](/oss/javascript/integrations/providers/groq) | [Groq supported models](https://console.groq.com/docs/models) |
...
| Model | [Tool calling](/oss/javascript/langchain/tools) | [Structured output](/oss/javascript/langchain/structured-output) | [Multimodal](/oss/javascript/langchain/messages#multimodal) |
|-|-|-|-|
...
| [`AzureChatOpenAI`](/oss/javascript/integrations/chat/azure_chat_openai) | ✅ | ✅ | ✅ |
...
| [`ChatMistralAI`](/oss/javascript/integrations/chat/mistralai) | ✅ | ✅ | ❌ |
...
| [`ChatTogether`](/oss/javascript/integrations/chat/together) | ✅ | ✅ | ❌ |
...
For the full list of chat model integrations and their capabilities, see the [chat models integrations page](/oss/javascript/integrations/chat).
...
| [LiteLLM](https://www.litellm.ai/) | [`ChatLiteLLM`](/oss/javascript/integrations/chat/litellm) | Unified interface for 100+ providers with routing, fallbacks, and spend tracking |
...
<CardGroup cols={2}>
    ...
    <Card title="All providers" icon="grid-2" href="/oss/javascript/integrations/providers/overview">
