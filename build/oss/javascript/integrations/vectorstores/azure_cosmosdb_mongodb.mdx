---
title: "Azure Cosmos DB for MongoDB vcore integration"
description: "Integrate with the Azure Cosmos DB for MongoDB vcore vector store using LangChain JavaScript."
---
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/vectorstores/azure_cosmosdb_mongodb.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
