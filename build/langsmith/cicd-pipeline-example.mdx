...
- <Icon icon="chart-line" /> **Offline evaluations**: Performance assessment using [AgentEvals](/oss/python/langchain/test), [OpenEvals](/langsmith/prebuilt-evaluators#setup) and [LangSmith](/langsmith/home).
