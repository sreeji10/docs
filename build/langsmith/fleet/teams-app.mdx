...
With LangSmith Fleet, you can connect your agents to Microsoft Teams by registering your own Azure Bot. Once connected, your agents can:
...
<Steps>
  <Step title="Open the integrations page">
    1. Navigate to **Fleet** in the [LangSmith UI](https://smith.langchain.com).
