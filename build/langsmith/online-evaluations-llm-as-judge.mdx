...
1. In the [LangSmith UI](https://smith.langchain.com), go to the **Tracing Projects** tab.
1. Select a tracing project.
1. Click on **+ New** in the top right corner of the tracing project page.
1. Click on **New Evaluator**.
1. Select the evaluator you want to configure.
...
View [LLM-as-a-judge evaluators](/langsmith/llm-as-judge#prebuilt-evaluators) for more information.
