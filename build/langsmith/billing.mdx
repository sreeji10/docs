...
- [Track contract usage (Enterprise)](#track-contract-usage-enterprise): Monitor your prepaid commitment consumption and usage patterns.
...
<Note>
Contract burndown tracking is available for **Enterprise plan** customers with prepaid commitments. You must have the `organization:manage` permission to access this feature.

For more details on the Enterprise plan, [contact the sales team](https://www.langchain.com/contact-sales).
</Note>

The contract burndown feature provides enterprise customers with visibility into their prepaid contract usage. It displays how much of your committed credits have been consumed, tracks monthly usage patterns, and shows your product rates.

### View contract burndown

To view your contract usage:

1. Navigate to **Settings** > **Usage Configuration**.
2. Select the **Contract Usage** tab.
